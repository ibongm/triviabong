...
export const ACHIEVEMENTS = [
    ...
    { id: 'first_blood', tier: 1, nameHr: 'Prvi korak', descriptionHr: 'Točno odgovorite na svoje prvo pitanje.', icon: Award },
    { id: 'category_explorer', tier: 1, nameHr: 'Sveznalac u nastajanju', descriptionHr: 'Odigrajte barem jednu rundu u svih 8 kategorija.', icon: Compass },
    ...
    { id: 'daily_habit', tier: 3, nameHr: 'Svakodnevna rutina', descriptionHr: 'Igrajte 3 dana zaredom.', icon: CalendarCheck },
    { id: 'weekly_warrior', tier: 3, nameHr: 'Tjedni ratnik', descriptionHr: 'Igrajte 7 dana zaredom.', icon: CalendarDays },
    { id: 'monthly_master', tier: 3, nameHr: 'Igrač mjeseca', descriptionHr: 'Igrajte 30 dana zaredom.', icon: Calendar },
    ...
    { id: 'century_club', tier: 4, nameHr: 'Klub 100', descriptionHr: 'Točno odgovorite na 100 pitanja ukupno.', icon: Medal },
    { id: 'trivia_legend', tier: 4, nameHr: 'Trivia Legenda', descriptionHr: 'Točno odgovorite na 1.000 pitanja ukupno.', icon: Crown },
    { id: 'flawless_victory', tier: 4, nameHr: 'Bez greške', descriptionHr: 'Odigrajte 3 savršene runde zaredom.', icon: ShieldCheck },
    ...
    { id: 'geographer', tier: 6, nameHr: 'Svjetski putnik', descriptionHr: '50 točnih odgovora u kategoriji Geografija.', icon: Globe },
    { id: 'history_buff', tier: 6, nameHr: 'Povjesničar', descriptionHr: '50 točnih odgovora u kategoriji Povijest.', icon: History },
